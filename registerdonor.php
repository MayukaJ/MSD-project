...
<form action="registerDonorHandler.php" style="border:1px solid #ccc" method="post">
  <div class="container">
    ...
    <input type="text" placeholder="Enter PhoneNumber" name="phone" maxlength="10" required>
